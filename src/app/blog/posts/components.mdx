---
title: "Компоненты в MDX"
publishedAt: "2025-04-20"
summary: "Примеры Once UI в теле поста: Feedback, Table, Code и прочее."
tag: "Документация"
---

HTML-теги из MDX частично маппятся на&nbsp;компоненты Once UI (см. `src/components/mdx.tsx`). Ниже — живые примеры; подписи к&nbsp;коду на&nbsp;английском сохранены там, где идут внутри демо.

## Обратная связь (Feedback)

Блок заметки / предупреждения / успеха.
...
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/feedback" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/table" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>

## Код

`CodeBlock` — подсветка, превью, копирование. `InlineCode` — внутри строки.

### CodeBlock

Полный синтаксис Once UI или обычные тройные backticks в MDX (см. `mdx.tsx`).
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/codeBlock" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/inlineCode" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/accordion" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/button" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/card" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/icon" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/flex" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/grid" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/Media" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
...
/>
<Row fillWidth bottomRadius="l" padding="4" border="neutral-medium" background="surface">
    <Button href="https://once-ui.com/docs/smart-link" weight="default" label="Документация Once UI" size="s" variant="tertiary" suffixIcon="chevronRight"/>
</Row>
</Column>
