...
const faqItems = [
  ...
  },
  {
    ...
    a: 'Стоимость зависит от сложности: лендинг — от 15 000 ₽, корпоративный сайт — от 40 000 ₽, веб-приложение — от 80 000 ₽. Точная оценка после обсуждения задачи.'
  },
  {
  ...
  },
  {
    ...
    a: 'Да. Работаю удалённо, общение через Telegram, Zoom. Москва и Московская область — возможны встречи при необходимости.'
  },
  {
    q: 'Предоставляете поддержку после запуска?',
    a: 'Да. После запуска — бесплатная поддержка по критическим вопросам в первые месяцы. Доработки — по договорённости.'
  }
]
